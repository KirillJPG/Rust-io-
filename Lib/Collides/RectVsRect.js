...
export class RectVsRect extends CheckerCollide{
    ...
    checkCollide(){
        ...
        const centerRect = new Vector(pos2.x+w2/2,pos2.y+h2/2)
        const centerRect2 = new Vector(pos1.x+w1/2,pos1.y+h1/2)
        const points = GetPointsRect(pos1.x,pos1.y,w1,h1,0)
        const points2 = GetPointsRect(pos2.x,pos2.y,w2,h2,0)
        points.reduce((pv,v)=>{
